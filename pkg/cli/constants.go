...
const (
	...
	AlmDevBaseApiUrl   = "https://alm.mobingi.com"  // dev API base url for ALM
	WaveDevBaseApiUrl  = "https://wave.mobingi.com" // dev API base url for Wave
	AlmTestBaseApiUrl  = "https://alm.mobingi.com"  // test API base url for ALM
	WaveTestBaseApiUrl = "https://wave.mobingi.com" // test API base url for Wave
